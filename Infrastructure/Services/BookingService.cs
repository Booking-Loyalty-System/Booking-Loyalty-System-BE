...
public class BookingService : IBookingService
{
    ...
    public async Task<BookingResponse> CreateBookingAsync(Guid userId, CreateBookingRequest request)
    {
        ...
        var booking = new Booking
        {
            ...
            BranchId = branch.Id,
            WashBayTimeSlotId = availableSlot.Id, // Khóa ngoại trỏ thẳng vào bảng trung gian 1-1
    ...
    public async Task<List<BookingResponse>> GetMyBookingsAsync(Guid userId)
    {
        ...
        return bookings.Select(b => MapToResponse(b, b.WashPackage, b.Vehicle, b.WashBayTimeSlot)).ToList();
    }
