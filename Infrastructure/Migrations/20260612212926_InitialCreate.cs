    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), new DateTime(2026, 6, 12, 21, 29, 25, 992, DateTimeKind.Utc).AddTicks(5191), "admin@system.com", null, true, "$2a$11$AAqClvZCqXkujGS6EtmbFOawrwVOjOrHgnmMSwpDt8FKIqT1OWM3K", null, null, "Admin", null },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2026, 6, 12, 21, 29, 26, 176, DateTimeKind.Utc).AddTicks(2400), "staff@system.com", null, true, "$2a$11$w9oW.G4hRPndHYxAXYC5HOWmW.1aIauwKtoUgR9dS9uYNkayGDzHW", null, null, "Staff", null },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), new DateTime(2026, 6, 12, 21, 29, 26, 360, DateTimeKind.Utc).AddTicks(1304), "customer@system.com", null, true, "$2a$11$4cnx/Teha0m9XTyKC4A5XuH9yGr9.Hg4QUEkIZjzOtDZudpAzDgN2", null, null, "Customer", null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("b1b2c3d4-0001-0001-0001-000000000001"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2521), "Bay A1 (Q9)", "Available", "Small,Medium" },
                    { new Guid("b1b2c3d4-0001-0001-0001-000000000002"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2538), "Bay A2 (Q9)", "Available", "Small,Medium" },
                    { new Guid("b1b2c3d4-0001-0001-0001-000000000003"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2542), "Bay B1 (Q9)", "Available", "Small,Medium,Large" },
                    { new Guid("b1b2c3d4-0001-0001-0001-000000000004"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2545), "Bay B2 (Q9)", "Available", "Small,Medium,Large" },
                    { new Guid("b1b2c3d4-0002-0001-0001-000000000001"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb02"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2560), "Bay A1 (TB)", "Available", "Small,Medium" },
                    { new Guid("b1b2c3d4-0002-0001-0001-000000000002"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb02"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2564), "Bay A2 (TB)", "Available", "Small,Medium" },
                    { new Guid("b1b2c3d4-0002-0001-0001-000000000003"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb02"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2568), "Bay B1 (TB)", "Available", "Small,Medium,Large" },
                    { new Guid("b1b2c3d4-0002-0001-0001-000000000004"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb02"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2571), "Bay B2 (TB)", "Available", "Small,Medium,Large" },
                    { new Guid("b1b2c3d4-0003-0001-0001-000000000001"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb03"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2548), "Bay A1 (Q3)", "Available", "Small,Medium" },
                    { new Guid("b1b2c3d4-0003-0001-0001-000000000002"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb03"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2552), "Bay A2 (Q3)", "Available", "Small,Medium" },
                    { new Guid("b1b2c3d4-0003-0001-0001-000000000003"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb03"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2555), "Bay B1 (Q3)", "Available", "Small,Medium,Large" },
                    { new Guid("b1b2c3d4-0003-0001-0001-000000000004"), new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbb03"), new DateTime(2026, 6, 12, 21, 29, 26, 361, DateTimeKind.Utc).AddTicks(2558), "Bay B2 (Q3)", "Available", "Small,Medium,Large" }
                });
