...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260609053733_AddLoyaltyTransactions")]
            ...
            modelBuilder.Entity("Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("77fbca87-3666-4c12-8363-1f871dd39b57"),
                            CreatedAt = new DateTime(2026, 6, 9, 5, 37, 31, 925, DateTimeKind.Utc).AddTicks(346),
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2026, 6, 9, 5, 37, 32, 103, DateTimeKind.Utc).AddTicks(5913),
                            Email = "admin@system.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$s6Rk6RwLfmwRC3yUJLlW7.K6AKe8xXBq3OoqzPW8U5Mh23N1cXojm",
                            Role = "Admin"
                        },
                        new
                        {
                            Id = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            CreatedAt = new DateTime(2026, 6, 9, 5, 37, 32, 279, DateTimeKind.Utc).AddTicks(45),
                            Email = "staff@system.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$tI2w7UNsGDrYrKARA5RnveSrXvQH6cQwCH0kpSrKk0NRW4SluVEF2",
                            Role = "Staff"
                        },
                        new
                        {
                            Id = new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"),
                            CreatedAt = new DateTime(2026, 6, 9, 5, 37, 32, 447, DateTimeKind.Utc).AddTicks(7246),
                            Email = "customer@system.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$YmZjbEk253Pnq2UsECCm4.Dy1hCqM0igISBARCf68O2sHeoEqimWi",
                            Role = "Customer"
                        });
                });
